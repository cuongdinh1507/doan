...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form method="POST" action="{!! route('event.update') !!}" id="formEdit" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="timeEdit" maxlength="30" type="datetime" class="form-control @error('name') is-invalid @enderror" name="time" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="addressEdit" maxlength="30" type="address" class="form-control @error('name') is-invalid @enderror" name="address" required autofocus>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form method="POST" action="{!! route('event.save') !!}" id="form1" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label text-md-right">Name</label>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input id="time" maxlength="30" type="datetime" class="form-control @error('time') is-invalid @enderror" name="time" value="{{ old('time') }}" required autofocus>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input id="address" maxlength="30" type="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autofocus>
...
<script>
    $(function(){
        ...
        $.get("{!! route('event.get') !!}", function(data){
            console.log(data);
            $("#tbody-subject").append(
                $.map(data, function(v,i){
                return $("<tr>").append(
                    $("<td>", { class: "" , text: i+1 }),
                    $("<td>", { class: "" ,text: v.titleEvent }),
                    $("<td>", { class: "w-5" ,text: v.timeEvent}),
                    $("<td>", { class: "w-5" ,text: v.addressEvent}),
                    $("<td>", { class: "w-20" ,text: v.descriptionEvent }),
                    $("<td>", { class: "w-25 text-center" }).append(
                        $("<img>", { src: v.imageEvent, class: "w-50" }),
                    ),
                    $("<td>", { class: "w-10 text-center"}).append(
                        $("<button>", { class: "btn btn-success mt-2 col-lg-8", "data-toggle":"modal", "data-target":"#edit"}).append(
                            $("<i>", { class: "fas fa-pencil-alt"}),
                        ).on("click", function(){
                            $("#subject_id").val(v.id);
                            $("#nameEdit").val(v.titleEvent);
                            $("#descriptionEdit").val(v.descriptionEvent);
                            $("#timeEdit").val(v.timeEvent);
                            $("#addressEdit").val(v.addressEvent);
                        }),
                        $("<button>", { class: "btn btn-danger mt-2 col-lg-8", "data-toggle":"modal", "data-target":"#delPi"}).append(
                            $("<i>", { class: "fas fa-trash-alt"}),
                        ).on("click", function(){
                            $(".modal-body-pi").text("Do you want to delete " + v.titleEvent + " ?").attr("subjectid", v.id);
                        }),
                    ),
                );
                }),
        ...
        delS = () => {
            ...
            $.get("{!! route('event.del') !!}", { id: id}, (data)=> {
                if(data == "ok")
                    location.reload();
            });
        };
